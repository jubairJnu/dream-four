...
const Header = () => {
  return (
    <div className="navbar bg-[#1653B2] fixed top-0 right-0 z-20  p-4 text-yellow-500 ">
  ...
  <div className="navbar-center hidden lg:flex ">
    ...
    <li className="hover:bg-white rounded-md hover:font-semibold "><Link>Our Service</Link></li>
